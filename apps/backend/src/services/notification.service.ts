...
export class NotificationService {
   ...
   */
  async createMoneyRequestNotification(
    userId: string,
    amount: number,
   ...
   */
  async createProfileUpdateNotification(userId: string) {
    return this.createNotification({
      userId,
      type: 'ACCOUNT',
   ...
   */
  async createPasswordChangeNotification(userId: string) {
    return this.createNotification({
      userId,
      type: 'ACCOUNT',
   ...
   */
  async createFailedTransactionNotification(
    userId: string,
    amount: number,
    reason: string,
    transactionId: string
