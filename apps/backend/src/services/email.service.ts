...
export class EmailService {
  ...
  async sendMoneyRequestEmail(user: UserData, transaction: TransactionData, requesterEmail: string): Promise<boolean> {
  ...
  async sendPasswordChangeEmail(user: UserData, changeDate: string): Promise<boolean> {
  ...
  async sendOTPEmail(user: UserData, otp: string, purpose: string): Promise<boolean> {
  ...
  async sendProfileUpdateEmail(user: UserData, updateType: string, updateDate: string): Promise<boolean> {
  ...
  async sendMoneyHeldEmail(user: UserData, amount: number, reason: string, holdDate: string): Promise<boolean> {
