...
class PaymentService {
     ...
     */
    async processPaymentAndAddFunds(paymentRequest) {
        ...
        try {
            ...
            const walletUpdate = await this.addFundsToWallet(paymentRequest.userId, paymentRequest.amount, paymentRequest.description || 'Bank deposit');
            ...
            const transaction = await this.createTransactionRecord(paymentRequest.userId, paymentRequest.amount, paymentRequest.description || 'Bank deposit', paymentResult.transactionId || 'unknown');
     ...
     */
    async processPaymentWithBank(paymentRequest) {
     ...
     * Add funds to user wallet
     */
    async addFundsToWallet(userId, amount, description) {
     ...
     * Create transaction record
     */
    async createTransactionRecord(userId, amount, description, reference) {
